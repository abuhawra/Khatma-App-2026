...
<style>
    ...
    /* حاوية الصف - استخدام block لضمان الترتيب من اليمين */
    .row-wrapper { 
        padding: 15px; 
    ...
    /* ضمان أزرار الحالة في جهة اليمين */
    div.stRadio > label { text-align: right !important; }
</style>
